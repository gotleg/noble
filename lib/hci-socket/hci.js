...
Hci.prototype.writeAclDataPkt = function(handle, cid, data) {
 if (this._currentPackets >= MAX_PACKETS)
  {
    console.log("too many packets without response : " + this._currentPackets);
    debug("too many packets without response : " + this._currentPackets);
  }
  else
  {
